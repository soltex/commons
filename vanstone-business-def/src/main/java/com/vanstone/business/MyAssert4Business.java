...
public abstract class MyAssert4Business {
	
	/**
	 * 必须初始化
	 * @param businessObject
	 */
	public static void objectInitialized(AbstractBusinessObject businessObject) {
		notNull(businessObject);
		if (businessObject.getId() == null) {
			throw new IllegalArgumentException(businessObject.getClass().getName() + " not initialized");
		}
	}
